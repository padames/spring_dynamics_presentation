...
1. The other from the imposition of the external oscilating force.
]
...
This is the steady state solution of the system.
...
<img src="project_directories_via_tree.png"
     ...
     style="position:absolute; right:500px; top:200px;">
...
Now we are in `tests/testthat/test-compute_displacement.R` 
...
In RStudio, when the file in the editor is `compute_complimentary_solution.R`
...
In RStudio, when the file in the editor is `test-compute_complimentary_solution.R`
and you type the following in the console:
